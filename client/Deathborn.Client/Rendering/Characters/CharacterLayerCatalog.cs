...
public static class CharacterLayerCatalog
{
    ...
    private static readonly Dictionary<string, LayerItem> Items = new(StringComparer.Ordinal)
    {
        ...
        ["farm-hair-lyria-brown"] = new(CharacterLayerId.FrontHair, null),
        ["farm-hair-lyria-black"] = new(CharacterLayerId.FrontHair, null),
        ["farm-hair-lyria-blonde"] = new(CharacterLayerId.FrontHair, null),
        ["farm-hair-lyria-ginger"] = new(CharacterLayerId.FrontHair, null),
    ...
    private static readonly Dictionary<string, string> FarmRpgLayerIds = new(StringComparer.Ordinal)
    {
        ...
        ["farm-hair-lyria-brown"] = "hair-lyria-brown",
        ["farm-hair-lyria-black"] = "hair-lyria-black",
        ["farm-hair-lyria-blonde"] = "hair-lyria-blonde",
        ["farm-hair-lyria-ginger"] = "hair-lyria-ginger",
