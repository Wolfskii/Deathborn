...
public static class NpcCatalog
{
    private static readonly Dictionary<string, NpcCatalogEntry> ById = new(StringComparer.Ordinal)
    {
        ...
        ["forest_slime"] = new() { DefId = "forest_slime", Name = "Slime", Category = NpcCategory.Monster, Disposition = NpcDisposition.Hostile, SpriteId = "slime", Radius = 12f, DisplayScale = 1.85f, Aggro = true, AggroRange = 48f, HitHalfWidth = 18f, HitHalfHeight = 16f, HitCenterYOffset = -14f },
        ...
        ["wild_bat"] = new() { DefId = "wild_bat", Name = "Bat", Category = NpcCategory.WildAnimal, Disposition = NpcDisposition.Hostile, SpriteId = "bat", Radius = 10f, DisplayScale = 1.45f, Aggro = true, AggroRange = 56f, HitHalfWidth = 16f, HitHalfHeight = 14f, HitCenterYOffset = -18f },
